...
##                        print (date + '\t' + cat + '\t' + field_cat20('3') +'\t'+ field_cat20('4') +'\t'+ field_cat20('12') +'\t'+ field_cat20('13')+'\t'+ field_cat20('14') +'\t'+ field_cat20('15') +'\t'+ field_cat20('19') +'\t'+ field_cat20('21')+'\n')
                        ...
                        a = open(filename_a, "a")
                        a.write(date + '\t' + cat + '\t' + field_cat20('3') +'\t'+ field_cat20('4') +'\t'+ field_cat20('12') +'\t'+ field_cat20('13')+'\t'+ field_cat20('14') +'\t'+ field_cat20('15') +'\t'+ field_cat20('19') +'\t'+ field_cat20('21')+'\n')
                        a.close()

            if match2 in cut_date: ## extract the lines with matching CAT type.
                cat21 = line
                date = cat21.split('|')[0]
                cat = cat21.split('|')[1]
                x = field_cat21('5') ## keep all the field5(Aircraft_ID) to variable x.
